...
Besides, I shared some practical tricks for deep learning(quite general), &nbsp; [DeepLearnigTricks](https://github.com/jasonustc/my_libs/blob/master/tricks.wiki.md).
